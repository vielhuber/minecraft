[![GitHub Tag](https://img.shields.io/github/v/tag/vielhuber/minecraft)](https://github.com/vielhuber/minecraft/tags)
[![Code Style](https://img.shields.io/badge/code_style-psr--12-ff69b4.svg)](https://www.php-fig.org/psr/psr-12/)
[![License](https://img.shields.io/github/license/vielhuber/minecraft)](https://github.com/vielhuber/minecraft/blob/main/LICENSE.md)
[![Last Commit](https://img.shields.io/github/last-commit/vielhuber/minecraft)](https://github.com/vielhuber/minecraft/commits)
...
- **Custom Weapons**
    ...
    - **Mace (modified)** - Vanilla Mace with restricted behaviour:
        - Not enchantable (enchanting table & anvil blocked, incl. repairing)
        - 6-second attack cooldown
        - Distribution to all players via `/stampfer`

- **Manhunt Mode** (`/fight`)
    - 3-minute PvP battle: Hunter vs Wegläufer
    - **Hunter Equipment**: Trident, Maze, Donneraxt, 64 Golden Apples (no armor)
    - **Wegläufer Equipment**: Water bucket, Diamond armor, Diamond shield, 64 Golden Carrots, 3 Ender Pearls, 64 Cobwebs
    - **Scoring System**:
        - Wegläufer survives 3 minutes: +1 point
        - Hunter kills Wegläufer: +1 point
        - Wegläufer kills Hunter: +2 points
    - Background music during fight (Pigstep)
    - Timer notifications every minute and at critical moments
...
- **Resource Pack Integration**
    - Custom weapon textures and models
    - Custom sounds
    - Automatic SHA1 hash management
    - Server-side deployment

- **Developer Tools**
    - `/reset` - Clear all mobs, stop Manhunt, restore players from Spectator, heal & feed all players, reset inventory
    - `/hirsch` - Spawn custom Warden boss
    - `/stampfer` - Give Mace to all online players (Admin only)
    - All commands (`/donneraxt`, `/machtklinge`, `/horde`, `/hirsch`, `/fight`, `/reset`, `/stampfer`) require operator permissions
    - Build scripts for local and production deployment with automatic server-icon and server.properties sync
...
- Java
    ...
    - Test: `java -version`
    - If that doesn't work: Check PATH and remove old entries (`where java`)
