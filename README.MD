...
- **Custom Weapons**
    ...
    - **Mace (modifiziert)** - Vanilla Mace mit eingeschränktem Verhalten:
        - Nicht verzauberbar (Zaubertisch & Amboss blockiert, inkl. Reparieren)
        - 6 Sekunden Angriffs-Cooldown
        - Verteilung an alle Spieler via `/stampfer`
